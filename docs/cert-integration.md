...
3. Prepare normalized events with `python -m ml.training.prepare_dataset --input ml/data/raw --output ml/data/prepared/events.jsonl`; review valid/invalid diagnostics, sample rows, and the SHA-256 fingerprint.
